...
<div class="inserttop">Danh sách thông tin đơn hàng đã duyệt</div>
<div class="insertcen">
...
<?php 
$sql=mysql_query("select * from hoadon where ngaygiao is not NULL") or die("loi truy vấn");
	...
	$ro=mysql_fetch_array($sq);
	 ?>
	  <tr class="tr2"><td style="border-left:1px solid #333;"><?php echo $ro["hoten"]; ?></td>
		...
		<td><a href='include/delete.php?idhd=<?php echo $mahd; ?>&act=del_hd' onclick='return check()' >Xóa</a></td></tr>
	<?php 
}
 ?></table></div>